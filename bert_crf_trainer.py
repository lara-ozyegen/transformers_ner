...
# model_checkpoints = ['allenai/scibert_scivocab_uncased', 'bionlp/bluebert_pubmed_uncased_L-24_H-1024_A-16', 'google-bert/bert-base-uncased', 'samrawal/bert-base-uncased_clinical-ner' ,'emilyalsentzer/Bio_ClinicalBERT', 'microsoft/deberta-base']
# 
...
for i in range(1):
  ...
  trainer = Trainer(
      model=model,
      args=training_args,
      compute_metrics=monitor.compute_metrics_factory(test_word_ids, fold_no=i, eval_dataset_name=dataset_name, model_name = model_name),
